...
{{--                                    <p>Responsible for designing, well planning, and supervising the drilling operations in the oil and gas industry.</p>--}}
{{--                                    <a href="Career/career.html">Read More<i class="fas fa-angle-right"></i></a>--}}
{{--                                </div>--}}
{{--                            </div>--}}
{{--                        </div>--}}
{{--                    </div>--}}
...
{{--                                    <span class="border border-2"></span>--}}
{{--                                </div>--}}
{{--                                <figure class="image-box"><img src="assets/images/resource/technonogy-2.png" alt=""></figure>--}}
{{--                                <div class="inner">--}}
{{--                                    <h3>Graphic Designer</h3>--}}
{{--                                    <p>Combines creativity and technical skills to create visual designs for a variety of mediums, including print, digital, and multimedia.</p>--}}
{{--                                    <a href="Career/career.html">Read More<i class="fas fa-angle-right"></i></a>--}}
{{--                                </div>--}}
{{--                            </div>--}}
{{--                        </div>--}}
...
{{--                                    <span class="border border-2"></span>--}}
{{--                                </div>--}}
{{--                                <figure class="image-box"><img src="assets/images/resource/technonogy-3.png" alt=""></figure>--}}
{{--                                <div class="inner">--}}
{{--                                    <h3>Senior Acountant</h3>--}}
{{--                                    <p>Responsible for overseeing the financial operations of a company or organization</p>--}}
{{--                                    <a href="Career/career.html">Read More<i class="fas fa-angle-right"></i></a>--}}
{{--                                </div>--}}
{{--                            </div>--}}
{{--                        </div>--}}
...
{{--                                    <span class="border border-2"></span>--}}
{{--                                </div>--}}
{{--                                <figure class="image-box"><img src="assets/images/resource/technonogy-4.png" alt=""></figure>--}}
{{--                                <div class="inner">--}}
{{--                                    <h3>Intern</h3>--}}
{{--                                    <p>Conducting research, assisting with administrative tasks, attending meetings and training sessions, and collaborating with other team members.</p>--}}
{{--                                    <a href="Career/career.html">Read More<i class="fas fa-angle-right"></i></a>--}}
{{--                                </div>--}}
{{--                            </div>--}}
{{--                        </div>--}}
