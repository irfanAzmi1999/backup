            ...
            <div class="col-lg-8 col-md-12 col-sm-12 content-side">
                    ...
                    <div class="inner-box">
                        ...
                        <div class="carousel-box">
                            <div class="top-box">
                                ...
                                <h3>Digital Well Plan</h3>
                                <p>Digitalization steps in Well design & Drilling Operations</p>
                                <p>Open API going through rapid Well Engineering & one integration calculation change: </p>
                            </div>
                            <div class="carousel-inner">
                                <div class="two-column-carousel-2 owl-carousel owl-theme owl-nav-none">
                                    ...
                                    <div class="single-item">
                                        ...
                                        <div class="inner">
                                            <p>Design well trajectories parametrically based on industrial standards-anti-collision and error modelling based on ISCWA</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="single-item">
                                        ...
                                        <div class="inner">
                                            <p>Advanced triaxial casing design allowing fully automated well design</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="single-item">
                                        ...
                                        <div class="inner">
                                            <p>This software ensures forensics torque and drag calculations
                                                through rigorous analysis of drilling, casing and completion operations.
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="single-item">
                                        <div class="box">
                                            ...
                                            <span>Features</span>
                                            <h4>
                                                Well Blowout and Kill Simulation
                                            </h4>
                                        </div>
                                        <div class="inner">
                                            <p>
                                                Performing dynamic kill according to all industry
                                                guidelines including Real Gas behaviour at various temperature depth.
                                            </p>
                                        </div>
                                    </div>
                        ...
                        <div class="row clearfix">
                            <div class="col-lg-4 col-md-6 col-sm-12 counter-block">
                                <div class="counter-block-one wow slideInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                                    <div class="inner-box">
                                        <div class="icon-box"><img src="../images/Engineering/efficient.png" alt="" style="height:70px"></div>
                                        <div class="count-outer count-box">
                                            <!-- <span class="count-text" data-speed="1500" data-stop="3500">0</span>+ -->
                                        </div>
                                        <h4>Efficient Well Planning</h4>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-12 counter-block">
                                <div class="counter-block-one wow slideInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                                    <div class="inner-box">
                                        <div class="icon-box"><img src="../images/Engineering/deal.png" alt="" style="height:70px"></div>
                                        <div class="count-outer count-box">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-12 counter-block">
                                <div class="counter-block-one wow slideInUp" data-wow-delay="300ms" data-wow-duration="1500ms">
                                    <div class="inner-box">
                                        <div class="icon-box"><img src="../images/Engineering/integrated.png" style="height:70px" alt=""></div>
                                        <div class="count-outer count-box">
                                            <!-- <span class="count-text" data-speed="1500" data-stop="239">0</span> -->
                                        </div>
                                        <h4>Best Practice-Integration</h4>
                                        <p>Lorem ipsum dolor sit amet consectetur.</p>
                                    </div>
                                </div>
                            </div>
              ...
              <hr style="margin-top: 50px;">
                <div style="text-align: center;margin-top:20px;">
                    <img style="width: 400px;margin-top: 100px;" src="../images/Engineering/oliasoft b.png" alt="" class="wow slideInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-12 col-sm-12 sidebar-side">
                <div class="service-sidebar">
                    ...
                    <ul class="sidebar-categories clearfix">
                        <li><a href="{{route('dwos')}}" class=""><h5>Well Simulator</h5><i class="flaticon-arrow"></i></a></li>
                        <li><a href="{{route('oliasoft')}}" class="active"><h5>Digital Well Plan</h5><i class="flaticon-arrow"></i></a></li>
                    </ul>
