    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Add Job Vacancy</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                ...
                <form action="{{route('job.store')}}" method="POST">
                    ...
                    <div class="card card-default">
                        <div class="card-header">
                            <h3 class="card-title">Job Vacancy Registration Form</h3>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="jobName" placeholder="Job Title" value="{{old('name')}}" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="shortDescription" id="" cols="30" rows="4" class="form-control" required></textarea>
...
{{--                                        <input type="text" class="form-control" name="jobDescription"  value="{{old('jobDescription')}}" placeholder="Job Description" >--}}
                                        <textarea name="jobDescription" rows="5"  value="{{old('jobDescription')}}" class="form-control" placeholder="Input Description" required>
                                    ...
                                    <div class="form-group">
                                        <label>Responsibility</label> <a  onclick="add()" style="cursor: pointer;">Add New</a>
                                        <input type="text" style="margin-bottom:20px" class="form-control" name="responsibility[]" placeholder="Add Responsibility..." value="{{old('responsibility')}}" required>
                                        <div id="reqs">
