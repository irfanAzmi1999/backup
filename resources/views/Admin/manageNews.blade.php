                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active"><a href="{{route('news.index')}}"></a>News</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
...
<script>
    ...
    {
        let confirmation = confirm('Are sure you want to delete News ('+newsID+') '+newsName+' ?');
