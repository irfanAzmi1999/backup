    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Add Service Category</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                ...
                <form action="{{route('createService')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card card-default">
                        <div class="card-header">
                            <h3 class="card-title">Add Service Category Form</h3>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="file" class="form-control" name="catServiceImage" onchange="loadFile(event)" required>
