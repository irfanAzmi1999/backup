                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active"><a href="{{route('job.create')}}"></a>Service Category</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
...
<script>
    function deleteServiceCat(id,catname)
    {
        var formID = "frm"+id;
        let confirmAction = confirm("Are you sure to delete this service category (id :"+id+"="+catname+")?\nWarning : The services under this category also will be deleted");
        if (confirmAction) {
