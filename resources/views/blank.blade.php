...
<html lang="zxx">
    <head>
        ...
        <link rel="icon" type="image/png" href="images/faazmiar-logo-only.png">
    </head>
                        ...
                        <div class="coming-soon-content">
                            <div class="d-table">
                                <div class="d-table-cell">
                                    <div class="logo">
                                        <a href="index.html"><img src="images/faazmiar.png" alt="logo"></a>
                                    </div>
                                    
                                    <h3>Our website is Coming Soon</h3>
                                    <button class="btn btn-primary" onclick="window.location.assign('index.html')">Return to homepage</button>
